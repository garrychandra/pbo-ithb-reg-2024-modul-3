...
public class dummy {
    public static void main(String[] args) {
        ...
        Presensi presensi = new Presensi(new Date(0), Status.HADIR);
        PresensiStaff presensiStaff = new PresensiStaff(new Date(0), Status.HADIR,new Time(0)); 
        ...
        Magister magister = new Magister("garry", "dipatiukur", "jakarta 2 desember 1900", 123456, 654321, "informatika","tbd");
        magister.getMatkul().add(matkulAmbil);

        Doktor doktor = new Doktor("garry", "dipatiukur", "jakarta 2 desember 1900", 123456, 654321, "informatika","tbd");
        doktor.setSidang1(100);

        DosenTetap dosenTetap = new DosenTetap("garry", "dipatiukur", "jakarta 2 desember 1900", 123456, 654321, "informatika",1000);
        dosenTetap.getMatkulAjar().add(matkulAjar);
        
        DosenHonorer dosenHonorer = new DosenHonorer("garry", "dipatiukur", "jakarta 2 desember 1900", 123456, 654321, "informatika",100);
